...
template<class T, sfbxRestrict(has_value_type<T>)> typename T::value_type get_value_type_impl(const T&);
template<class T, sfbxRestrict(std::is_array_v<T>)> T get_value_type_impl(const T&);
template<class T, sfbxRestrict(std::is_pointer_v<T>)> std::remove_pointer_t<T> get_value_type_impl(T);
template<class T, sfbxRestrict(std::is_scalar_v<T> && !std::is_pointer_v<T>)> T get_value_type_impl(T);

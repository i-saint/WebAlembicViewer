...
#define SF(T)                                                                                       \
    ...
    inline bool near_equal(T a, T b, T epsilon = T(wabcEpsilon)) { return std::abs(a - b) < epsilon; }\
...
template<class T> inline bool near_equal(const tvec2<T>& a, const tvec2<T>& b, T e = wabcEpsilon)
{
    return near_equal(a.x, b.x, e) && near_equal(a.y, b.y, e);
}
template<class T> inline bool near_equal(const tvec3<T>& a, const tvec3<T>& b, T e = wabcEpsilon)
{
    return near_equal(a.x, b.x, e) && near_equal(a.y, b.y, e) && near_equal(a.z, b.z, e);
}
template<class T> inline bool near_equal(const tvec4<T>& a, const tvec4<T>& b, T e = wabcEpsilon)
{
    return near_equal(a.x, b.x, e) && near_equal(a.y, b.y, e) && near_equal(a.z, b.z, e) && near_equal(a.w, b.w, e);
}
template<class T> inline bool near_equal(const tquat<T>& a, const tquat<T>& b, T e = wabcEpsilon)
{
    return near_equal(a.x, b.x, e) && near_equal(a.y, b.y, e) && near_equal(a.z, b.z, e) && near_equal(a.w, b.w, e);
}
template<class T> inline bool near_equal(const tmat2x2<T>& a, const tmat2x2<T>& b, T e = wabcEpsilon)
{
    return near_equal(a[0], b[0], e) && near_equal(a[1], b[1], e);
}
template<class T> inline bool near_equal(const tmat3x3<T>& a, const tmat3x3<T>& b, T e = wabcEpsilon)
{
    return near_equal(a[0], b[0], e) && near_equal(a[1], b[1], e) && near_equal(a[2], b[2], e);
}
template<class T> inline bool near_equal(const tmat4x4<T>& a, const tmat4x4<T>& b, T e = wabcEpsilon)
{

...
#define ssdsRestrict(...) std::enable_if_t<__VA_ARGS__, bool> = true
...
template<class T, ssdsRestrict(has_value_type<T>)> inline typename T::value_type get_value_type_impl(const T&);
template<class T, ssdsRestrict(std::is_array_v<T>)> inline T get_value_type_impl(const T&);
template<class T, ssdsRestrict(std::is_pointer_v<T>)> inline std::remove_pointer_t<T> get_value_type_impl(T);
template<class T, ssdsRestrict(std::is_scalar_v<T> && !std::is_pointer_v<T>)> inline T get_value_type_impl(T);
